...
class EHRgeneratorOW:

    # patient record generator in occurrence window scenario
    ...
    def save_record(self, saving_dir):
        saving = saving_dir + "occurrence_window_patient_record.pkl"
    ...
    def save_record_nfold(self, saving_dir):
        ...
        for n, fold_record in enumerate(self.fold_record):
            saving = saving_dir + "occurrence_window_patient_record_{}fold.pkl".format(n)
    ...
    def save_params(self, saving_dir):
        ...
        saving = saving_dir + "occurrence_window_params.pkl"
    ...
    def generate_record(self, generation_num):
        ...
        for i, rl in enumerate(tqdm(record_len)):
            ...
            # calculate code occurrences 
            occurrence_count = calculate_occurrence(code_binary[-self.params["window_size"]:], self.confounding_var)
